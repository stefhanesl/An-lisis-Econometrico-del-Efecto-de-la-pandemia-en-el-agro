...
use "/Users/juancarlosharo/Desktop/Integradora/RESULTADOS/arrozfinal.dta", clear
...
*--------------------------------------------------------
gen ln_fertilizantes = ln(fertilizantes)
hist ln_fertilizantes
...
global xlist2 sexo edad primaria secundaria universidad ninguna_for hectareas_total af_sequia af_plagas af_inundacion af_edad_plantacion riego almacenamiento area_empaque m_labranza m_sembradora bomba_manual bomba_estacionaria cosechadora parroquia*
...
**----------------------------------------------------------------
*................................................................
twoway hist pprobit if $treatment == 1 || hist pprobit if $treatment == 0, fcolor(none) lcolor(blue) legend(label(1 "Tratamiento") label(2 "Control")) xtitle("Probabilidad de ser afectado en la compra de insumos") ytitle("Densidad") title("Histograma Arroz")
...
gen groups = tratamiento_compra_insumos if soporteComun == 1
asdoc ttest edad, by(groups)	
...
*Variable de interes
sum fertilizantes if $treatment == 0

asdoc sum fertilizantes if $treatment == 0 , replace tzok dec(4)
