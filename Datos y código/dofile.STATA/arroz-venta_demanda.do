...
**----------------------------------------------------------------
*................................................................
twoway hist pprobit if $treatment == 1 || hist pprobit if $treatment == 0, fcolor(none) lcolor(blue) legend(label(1 "Tratamiento") label(2 "Control")) xtitle("Probabilidad de ser afectado en las ventas por falta de demanda") ytitle("Densidad") title("Histograma Arroz")
...
*************Variable cambiante
gen soporteComun = 0
replace soporteComun = 1 if pprobit>= 0.1084572 & pprobit<= 0.7237853
