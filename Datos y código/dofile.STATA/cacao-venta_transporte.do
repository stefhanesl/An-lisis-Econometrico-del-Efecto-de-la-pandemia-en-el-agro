...
**----------------------------------------------------------------
*................................................................
twoway hist pprobit if $treatment == 1 || hist pprobit if $treatment == 0, fcolor(none) lcolor(blue) legend(label(1 "Tratamiento") label(2 "Control")) xtitle("Probabilidad de ser afectado en las ventas por falta de transporte") ytitle("Densidad") title("Histograma Cacao")
...
*************Variable cambiante
gen soporteComun = 0
replace soporteComun = 1 if pprobit>= 0.2176581 & pprobit<= 0.702645  
...
*Variable de interes
sum ventas_toneladas if $treatment == 1 
asdoc sum ventas_toneladas if $treatment == 1 , replace tzok dec(4)
