...
use "/Users/juancarlosharo/Desktop/Integradora/RESULTADOS/maizfinal.dta", clear
...
**----------------------------------------------------------------
*................................................................
twoway hist pprobit if $treatment == 1 || hist pprobit if $treatment == 0, fcolor(none) lcolor(blue) legend(label(1 "Tratamiento") label(2 "Control")) xtitle("Probabilidad de ser afectado en la compra de insumos") ytitle("Densidad") title("Histograma Maíz")
...
*************Variable cambiante
gen soporteComun = 0
replace soporteComun = 1 if pprobit>= 0.1418998 & pprobit<= 0.7511587 
...
*Variable de interes
sum fertilizantes if $treatment == 1 
asdoc sum fertilizantes if $treatment == 1 , replace tzok dec(4)
