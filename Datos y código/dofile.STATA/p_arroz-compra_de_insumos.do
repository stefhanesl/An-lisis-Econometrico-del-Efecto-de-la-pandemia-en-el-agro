...
use "/Users/juancarlosharo/Desktop/Integradora/RESULTADOS PARÁMETRO/arrozfinal.dta"
...
*--------------------------------------------------------
gen ln_splantada_fert = ln(parametro_insumos)
hist ln_splantada_fert
...
*--------------------------------------------------------
global ylist ln_splantada_fert

global treatment tratamiento_compra_insumos
...
global xlist2 sexo edad primaria secundaria universidad ninguna_for hectareas_total af_sequia af_plagas af_inundacion af_edad_plantacion riego almacenamiento area_empaque m_labranza m_sembradora bomba_manual bomba_estacionaria cosechadora parroquia* edadC hectareas_total2
...
**----------------------------------------------------------------
*................................................................
twoway hist pprobit if $treatment == 1 || hist pprobit if $treatment == 0, fcolor(none) lcolor(blue) legend(label(1 "Tratamiento") label(2 "Control")) xtitle("Probabilidad de ser afectado en compra de fertilizantes por hectarea") ytitle("Densidad") title("Histograma Arroz")
...
*************Variable cambiante
gen soporteComun = 0
replace soporteComun = 1 if pprobit>= .104382 & pprobit<= .6252049  
...
*Variable de interes
sum parametro_insumos if $treatment == 0
asdoc sum parametro_insumos if $treatment == 0 , replace tzok dec(4)
...
sum hectareas_total if $treatment == 0

di 56.650658*26.35193
