...
use "/Users/juancarlosharo/Desktop/Integradora/RESULTADOS PARÁMETRO/cacaofinal.dta", clear
*-----------------------------------------------------------
...
**----------------------------------------------------------------
*................................................................
twoway hist pprobit if $treatment == 1 || hist pprobit if $treatment == 0, fcolor(none) lcolor(blue) legend(label(1 "Tratamiento") label(2 "Control")) xtitle("Probabilidad de ser afectado en compra de fertilizantes por hectarea") ytitle("Densidad") title("Histograma Cacao")
...
*************Variable cambiante
gen soporteComun = 0
replace soporteComun = 1 if pprobit>= .112623 & pprobit<= .6208522
