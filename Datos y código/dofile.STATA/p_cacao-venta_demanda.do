...
**----------------------------------------------------------------
*................................................................
twoway hist pprobit if $treatment == 1 || hist pprobit if $treatment == 0, fcolor(none) lcolor(blue) legend(label(1 "Tratamiento") label(2 "Control")) xtitle("Probabilidad de ser afectado en ventas/hectarea por falta de demanda") ytitle("Densidad") title("Histograma Cacao")
...
*************Variable cambiante
gen soporteComun = 0
replace soporteComun = 1 if pprobit>= .2025145 & pprobit<= .6950614 
...
*Impacto cuantitativo con soporte común
di .8345287* -.1450225
