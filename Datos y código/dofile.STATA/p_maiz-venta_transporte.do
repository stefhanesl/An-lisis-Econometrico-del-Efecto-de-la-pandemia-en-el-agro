...
use "/Users/juancarlosharo/Desktop/Integradora/RESULTADOS PARÁMETRO/maiz_p.dta", clear
...
**----------------------------------------------------------------
*................................................................
twoway hist pprobit if $treatment == 1 || hist pprobit if $treatment == 0, fcolor(none) lcolor(blue) legend(label(1 "Tratamiento") label(2 "Control")) xtitle("Probabilidad de ser afectado en ventas por hectarea a causa del transporte") ytitle("Densidad") title("Histograma Maíz")
...
*************Variable cambiante
gen soporteComun = 0
replace soporteComun = 1 if pprobit>= .1893473 & pprobit<= .7965065 
